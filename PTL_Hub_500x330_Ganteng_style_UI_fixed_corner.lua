...
local PINK = Color3.fromRGB(145, 255, 75)
local PINK2 = Color3.fromRGB(190, 255, 135)
local BG = Color3.fromRGB(8, 12, 10)
local PANEL = Color3.fromRGB(12, 18, 15)
local CARD = Color3.fromRGB(10, 16, 13)
local WHITE = Color3.fromRGB(248, 248, 248)
local MUTED = Color3.fromRGB(185, 210, 188)
...
TopBar.BackgroundColor3 = Color3.fromRGB(9, 14, 12)
...
Sidebar.Size = UDim2.fromOffset(145, 236)
...
Content.Size = UDim2.new(1, -175, 0, 236)
Content.Position = UDim2.fromOffset(165, 66)
...
Search.Size = UDim2.fromOffset(125, 28)
Search.Position = UDim2.new(1, -125, 0, 8)
Search.BackgroundColor3 = Color3.fromRGB(10, 17, 14)
...
HeaderLine.BackgroundTransparency = 0.18
...
local function addCard(titleText, descText, buttonText, callback)
    ...
    Name.Size = UDim2.new(1, -102, 0, 17)
    ...
    Desc.Size = UDim2.new(1, -102, 0, 13)
    Desc.Position = UDim2.fromOffset(10, 19)
    ...
    Run.Size = UDim2.fromOffset(72, 24)
    Run.Position = UDim2.new(1, -80, 0.5, -12)
    Run.BackgroundColor3 = Color3.fromRGB(7, 28, 12)
    Run.Text = buttonText
    ...
    Run.MouseEnter:Connect(function()
        TweenService:Create(Run, TweenInfo.new(0.12), {
            BackgroundColor3 = Color3.fromRGB(30, 75, 38)
        }):Play()
    end)

    Run.MouseLeave:Connect(function()
        TweenService:Create(Run, TweenInfo.new(0.12), {
            BackgroundColor3 = Color3.fromRGB(7, 28, 12)
        }):Play()
    end)
...
Search:GetPropertyChangedSignal("Text"):Connect(function()
    ...
    for _, child in ipairs(List:GetChildren()) do
        if child:IsA("Frame") then
            ...
            if label then
                child.Visible = query == "" or string.find(string.lower(label.Text), query, 1, true) ~= nil
            end
        end
    end
end)
...
local function addTab(name)
    ...
    Button.BackgroundColor3 = Color3.fromRGB(11, 18, 15)
...
FooterLine.BackgroundTransparency = 0.18
