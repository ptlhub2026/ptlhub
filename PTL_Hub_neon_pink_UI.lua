...
local pages = {
    ["Thông Tin"] = function()
        ...
        addCard("Youtuber", "ZEUSz Roblox", "SAO CHÉP LINK", function() print("YouTube selected") end)
    ...
    ["Script PRE"] = function()
        ...
        for _,v in ipairs(cards:GetChildren()) do if not v:IsA("UIListLayout") then v:Destroy() end end
        addCard("BANANA PREMIUM", "Premium Script", "RUN", function() print("Banana selected") end)
