...
local BG = Color3.fromRGB(4, 10, 6)
local PANEL = Color3.fromRGB(7, 17, 10)
local CARD = Color3.fromRGB(8, 22, 12)
...
TopBar.BackgroundColor3 = Color3.fromRGB(5, 13, 7)
...
local function addTab(name)
    ...
    Button.BackgroundColor3 = Color3.fromRGB(7, 21, 11)
    Button.Text = name
